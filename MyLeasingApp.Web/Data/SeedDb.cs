using MyLeasingApp.Web.Data.Entities;

namespace MyLeasingApp.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckPropertyTypesAsync()
        {
            if ( !_context.PropertyTypes.Any() )
            {
                ...
                AddPropertyType("Casa");
                AddPropertyType("Negocio");
        ...
        private void AddPropertyType( string Name )
        {
